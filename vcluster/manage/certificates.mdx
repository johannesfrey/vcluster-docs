...
## Rotate the CA when running vCluster Private Nodes

After rotating the CA you have to rejoin any previously joined Private Node.

:::info
The below steps have to be repeated for each Private Node.
:::
